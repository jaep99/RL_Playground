...
if __name__ == '__main__':
    ...
    env = gym.make('UnicyclePendulumTrajectory-v0-paul', render_mode=None, max_episode_steps=MAX_EPISODE_STEPS)
    ...
    if args.test:
        if os.path.isfile(args.test):
            test_env = gym.make('UnicyclePendulumTrajectory-v0-paul', render_mode='human', max_episode_steps=MAX_EPISODE_STEPS)
